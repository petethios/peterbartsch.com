...
<head>
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "Article",
      "headline": "FourKites: Realigning Incentives",
      "description": "Designing a rewards system that made data sharing beneficial for both drivers and the platform.",
      "author": {"@type": "Person", "name": "Peter Bartsch", "url": "https://petebartsch.com"},
      "url": "https://petebartsch.com/case-studies/fourkites-driver"
    }
    </script>
</head>
<body>
    ...
    <main class="case-study-page">
        <article>
            ...
            <nav class="case-study-nav" aria-label="Case study navigation">
                ...
                <a href="fourkites-mobile.php">Next: Mobile — Subtract vs Compress →</a>
            </nav>
        </article>
    </main>
