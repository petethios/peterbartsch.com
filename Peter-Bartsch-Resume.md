...
* Shipped a complete product ecosystem solo — 6 sphere variants with CAD models, prototype, and first revenue across every surface.
...
* Redesigned the license management system for connected ag equipment (Automation/AI services) serving 500K+ users across 12 languages — mapped flows, license states, and edge cases (expired/renewed/transferred/dealer-managed); profile completion 34%→87%, –16% support tickets, enabled $3.8B in connected-services revenue.

* Reduced design-to-development time 45% by building the first dev-ready tokens, prop specs, and full state coverage for the enterprise design system in Figma spanning 6 brands and 40+ product teams globally — handoffs that shipped.
...
Member, Board of Directors  |  How Weird Street Faire 501(c)(3), San Francisco  |  2000 – 2024